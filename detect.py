...
def run(
        weights=r'D:\DIP_final_0109\DIP_final\yolov5-Kfolds-1225-test\yolov5x-e-100-fold-1\weights\best.pt',  # model path or triton URL
        source=r'D:\DIP_final_0109\DIP_final\DIP_final\datasets_folds_1\images\valid\powder_uncoverconverted_ 0129.png',  # file/dir/URL/glob/screen/0(webcam)
        data=r'D:\DIP_final_0109\DIP_final\DIP_final/datasets_folds_1.yaml',  # dataset.yaml path
